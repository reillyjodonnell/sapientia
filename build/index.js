...
function TopicCard({
  ...
  const [upvote, setUpvote] = (0, import_react14.useState)(liked);
...
function Index2() {
  const { likedPostIds, data: data2, name } = (0, import_react15.useLoaderData)();
