...
var action = async ({ request }) => {
  ...
  let fieldErrors = {
    url: validateUrl2(url),
    title: validateTitle(title),
    authorOfPost: validateAuthor(authorOfPost)
  };
  if (Object.values(fieldErrors).some(Boolean)) {
    return { fieldErrors, fields: { url, title, authorOfPost } };
  }
